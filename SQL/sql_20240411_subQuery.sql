...
복잡한 데이터추출 및 조작작업에 유용하며 유연성과 기능확장에 도움이 됨
단, 지나치게 복잡한 서브뭐리를 사용하면 성능을 저하시킬 수 있음*/
